...
def is_correct_connection_string():
    foundHost = re.search("HostName=.*;DeviceId=.*;", AzureHubConnectionString)
    if foundHost:
        return True
    else:
        return False
...
#--------------------------------------------------------------------
# Purpose:
#     Convert an array of bytes back into a double 
#
# Notes:
#     None.
#--------------------------------------------------------------------
...
#--------------------------------------------------------------------
# Purpose:
#     Convert an array of bytes back into an int32 
#
# Notes:
#     None.
#--------------------------------------------------------------------
...
#--------------------------------------------------------------------
# Purpose:
#     Return the message from Local MQTT 
#
# Notes:
#     None.
#--------------------------------------------------------------------
...
#--------------------------------------------------------------------
# Purpose:
#     Find the host name from the connection string
#
# Notes:
#     None.
#--------------------------------------------------------------------
def parse_iot_hub_name():
    m = re.search("HostName=(.*?)\.", AzureHubConnectionString)
    return m.group(1)
