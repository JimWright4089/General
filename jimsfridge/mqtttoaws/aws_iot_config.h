...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "ao36l44clzyiu.iot.us-west-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "JimsFridgeAWSIoT" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 	       "JimsFridgeAWSIot" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "root-CA.crt" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "JimsFridgeAWSIot.cert.pem" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "JimsFridgeAWSIot.private.key" ///< Device private key filename
// =================================================
